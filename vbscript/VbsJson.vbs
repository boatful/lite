Class VbsJson
	...
	' NB: str = {...} IS EXPECTED! str = [...] WILL FAIL!
    ...
    Private Sub Class_Initialize
        ...
        Set NumberRegex = New RegExp ' WORKS FINE, NO NEED FOR: CreateObject("vbscript.RegExp")
        NumberRegex.Pattern = "(-?(?:0|[1-9]\d*))(\.\d+)?([eE][-+]?\d+)?"
        NumberRegex.Global = False
        NumberRegex.MultiLine = True
        NumberRegex.IgnoreCase = True

        Set StringChunk = New RegExp ' WORKS FINE, NO NEED FOR: CreateObject("vbscript.RegExp")
